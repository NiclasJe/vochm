...
class AnimalFindingEndpoint extends Endpoint {
  Future<void> insertAnimalFinding(Session session, double latitude, double longitude, int animalId) async {
  ...
  Future<double> getNearestNeighborsForAnimal(Session session, int animalId) async {
